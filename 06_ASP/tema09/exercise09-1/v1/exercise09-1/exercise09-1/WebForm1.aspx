...
<body>
    ...
    <div>
        ...
        <asp:DropDownList ID="DropDownList2" runat="server"
            ...
            AutoPostBack="true"
            AppendDataBoundItems="true">
            <asp:ListItem Text="Selecciona un empleado" Value="" />
        </asp:DropDownList>
        ...
        <asp:SqlDataSource ID="SqlDataSource2" runat="server"
            DataSourceMode="DataReader"
            ConnectionString="<%$ ConnectionStrings:Northwind %>"
            SelectCommand="select Employees.Title, Employees.EmployeeID, (Employees.FirstName + ' ' + Employees.LastName) as formattedEmployee from Employees inner join Orders on Employees.EmployeeID = Orders.EmployeeID inner join Customers on Orders.CustomerID = Customers.CustomerID where Customers.CustomerID = @customerId">
            <SelectParameters>
