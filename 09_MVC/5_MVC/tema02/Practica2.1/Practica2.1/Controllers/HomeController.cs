...
namespace Practica2._1.Controllers
{
    public class HomeController : Controller
    {
        ...
        { 
            Coche[] coches = {
                new Coche {Color="Rojo",Marca="Fiat",Modelo="Ger"},
            ...
            {
                resultado.AppendFormat("Color: {0} ", r.Color);
                resultado.AppendFormat("Marca: {0} ", r.Marca);
                resultado.AppendFormat("Modelo: {0} ", r.Modelo);
        ...
        {
            Coche[] coches ={
                                new Coche {Color="Rojo",Marca="Fiat",Modelo="Ger",precio=30000},
